...
"use strict";var DictionaryLoader=require("./DictionaryLoader");function BrowserDictionaryLoader(r){DictionaryLoader.apply(this,[r])}self.kuromoji||(self.kuromoji={cached_dics:[]}),BrowserDictionaryLoader.prototype=Object.create(DictionaryLoader.prototype),BrowserDictionaryLoader.prototype.loadArrayBuffer=function(r,o){var e=self.kuromoji.cached_dics.find(function(o){return o.url===r});e||(e={fetch:fetch(r).then(function(r){return new Promise(function(o,e){r.ok||e(r.statusText),r.arrayBuffer().then(function(r){o(r)})})}),url:r},self.kuromoji.cached_dics.push(e)),e.fetch.then(function(r){o(null,r)}).catch(function(r){o(r,null)})},module.exports=BrowserDictionaryLoader;

},{"./DictionaryLoader":17}],17:[function(require,module,exports){
"use strict";var async=require("async"),DynamicDictionaries=require("../dict/DynamicDictionaries");function DictionaryLoader(n){this.dic=new DynamicDictionaries,this.dic_path=n}DictionaryLoader.prototype.loadArrayBuffer=function(n,t){throw new Error("DictionaryLoader#loadArrayBuffer should be overwrite")},DictionaryLoader.prototype.load=function(n){var t=this.dic,r=this.dic_path,i=this.loadArrayBuffer;async.parallel([function(n){async.map(["base.dat","check.dat"],function(n,t){i(new URL(n,r).toString(),function(n,r){if(n)return t(n);t(null,r)})},function(r,i){if(r)return n(r);var a=new Int32Array(i[0]),o=new Int32Array(i[1]);t.loadTrie(a,o),n(null)})},function(n){async.map(["tid.dat","tid_pos.dat","tid_map.dat"],function(n,t){i(new URL(n,r).toString(),function(n,r){if(n)return t(n);t(null,r)})},function(r,i){if(r)return n(r);var a=new Uint8Array(i[0]),o=new Uint8Array(i[1]),e=new Uint8Array(i[2]);t.loadTokenInfoDictionaries(a,o,e),n(null)})},function(n){i(new URL("cc.dat",r).toString(),function(r,i){if(r)return n(r);var a=new Int16Array(i);t.loadConnectionCosts(a),n(null)})},function(n){async.map(["unk.dat","unk_pos.dat","unk_map.dat","unk_char.dat","unk_compat.dat","unk_invoke.dat"],function(n,t){i(new URL(n,r).toString(),function(n,r){if(n)return t(n);t(null,r)})},function(r,i){if(r)return n(r);var a=new Uint8Array(i[0]),o=new Uint8Array(i[1]),e=new Uint8Array(i[2]),c=new Uint8Array(i[3]),u=new Uint32Array(i[4]),d=new Uint8Array(i[5]);t.loadUnknownDictionaries(a,o,e,c,u,d),n(null)})}],function(r){n(r,t)})},module.exports=DictionaryLoader;
